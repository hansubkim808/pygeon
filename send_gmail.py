...
def mp3_to_gmail(file_vec, mailing_list, subj, body):
    ...
    sender_email = credentials.readlines()[0]
    password = credentials.readlines()[1]
    message = body
    ...
    with smtplib.SMTP_SSL(smtp_server, port, context=context) as server:
        ...
        try:
            server.sendmail(sender_email, recipients, full_email)
...
def main():
    ...
    parser.add_argument("-f", "--filenames", help="Space-delimited list of files to email")
